<header class="header-global fixed-top bg-black ">
        <nav id="navbar-main "
            ...
            <div class="container my-3">
                <a class="navbar-brand @@logo_classes" href="../../index.html">
                    ...
                    <img class="navbar-brand-light common" src="./dashboard/assets/img/brand/dark.svg" height="35"
                        alt="Logo dark"> -->
                    <img class="navbar-brand-light common" src="./dashboard/assets/img/logo/deped-logo-white.png"
                        height="70" alt="Logo dark">
                    ...
                    <div class="navbar-collapse-header">
                        <div class="row">
                            <div class="col-6 collapse-brand">
                                <a href="../../index.html">
                                    <img src="./dashboard/assets/img/logo/deped-logo-black.png" height="35" alt="Logo Impact">
                ...
                <!-- Button Navbar in Media Display -->
