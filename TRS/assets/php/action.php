                                        ...
                                        <tr>
                                            <td class="content-cell">
                                                <div class="f-fallback">
                                                    <h1>Hi '. $user_found['name'] .',</h1>
                                                    <p>You recently requested to reset your password for your
                                                        <strong>WebApps</strong> account. Use the button below to reset it. <br>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <a href="http://localhost/WebApps/TRS/reset-pass.php?email='.$email.'&token='.$token.'"
                                                    ...
                                                    <p>Thanks,
                                                        <br>The <strong>WebApps</strong> team
                                                    </p>
                                                    <!-- Sub copy -->
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p class="f-fallback sub">
                                                                    http://localhost/WebApps/TRS/reset-pass.php?email='.$email.'&token='.$token.'
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
