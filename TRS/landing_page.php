...
<head>
    ...
    <meta itemprop="image"
        content="https://themesberg.s3.us-east-2.amazonaws.com/public/products/impact-design-system/impact-design-system-thumbnail.jpg">
    ...
    <!-- Favicon -->
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="120x120" href="./front/assets/img/favicon/apple-touch-icon.png">
        ...
        <nav id="navbar-main"
            ...
            <div class="container">
                <a class="navbar-brand d-none" href="./index.html">
                    <img class="navbar-brand-dark common" src="./front/assets/img/brand/light.svg" height="35"
                        alt="Logo light">
                    <img class="navbar-brand-light common" src="./front/assets/img/brand/dark.svg" height="35"
                        alt="Logo dark">
                </a>
                    ...
                    <ul class="navbar-nav navbar-nav-hover justify-content-center">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" id="pages_submenu">
                                ...
                                <li><a class="dropdown-item" href="./dashboard/pages/examples/profile.html">Profile</a>
                                </li>
    ...
    <main>
        ...
        <div class="preloader bg-soft flex-column justify-content-center align-items-center">
            <div class="loader-element">
                ...
                <img src="./front/assets/img/brand/dark-loader.svg" height="40" alt="Impact logo">
            </div>
        </div>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5">
                    <div class="col-12 col-sm-8 col-md-7 col-lg-6 text-center">
                        <img src="./front/assets/img/brand/light.svg" class="mb-4" height="65" alt="Logo Impact">
                        <h1 class="display-4 text-muted mb-5 font-weight-normal">The ultimate design system for your
                            online business</h1>
                        <div class="d-flex align-items-center justify-content-center mb-5">
                            <a href="https://themesberg.com/product/bootstrap-themes/impact-design-system"
                                target="_blank" class="btn btn-secondary mb-3 mt-2 mr-3 animate-up-2"><span
                                    class="fas fa-cloud-download-alt mr-2"></span> Download</a>
                            <div class="mt-1">
                                <!-- Place this tag where you want the button to render. -->
                                <a class="github-button"
                                    href="https://github.com/creativetimofficial/impact-design-system"
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <a href="https://themesberg.com?ref=creativetim" class="mr-4" target="_blank">
                                <img src="./front/assets/img/themesberg.svg" height="40" alt="Themesberg Logo">
                                <span class="d-block text-muted font-small mt-2">Themesberg</span>
                            </a>
                            <a href="https://creative-tim.com" target="_blank">
                                <img src="./front/assets/img/creative-tim-circle.png" height="40"
            ...
            <div class="container">
                ...
                <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
                    <div class="col-lg-5 order-lg-2">
                        ...
                        <p class="mb-5">Showcase your startup with the front and landing pages it deserves. With a lot
                            of care we developed some of the best presentational pages you can get.</p>
                        <div class="d-flex justify-content-between align-items-center mt-lg-4 mb-4">
                            <div class="d-block">
                                <a href="./front/pages/index.html"
                                    class="btn btn-secondary mr-3 animate-up-2 mb-3">Front demo</a>
                                <a href="https://demos.creative-tim.com/impact-design-system-pro/docs/front/accordions/"
                                    class="btn btn-outline-gray animate-up-2 mb-3"><i class="fas fa-th-large mr-2"></i>
                                    Components</a>
                            </div>
                        </div>
                        <a href="https://themesberg.com?ref=creative-tim-impact-pro-joint" class="d-block mb-5"
                            target="_blank">
                            <div class="author-image mr-2 d-flex">
                                <img src="./front/assets/img/themesberg.svg" alt="Themesberg Logo">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <img src="./front/assets/img/presentation-mockup-2.jpg" alt="Front pages overview">
                    </div>
                </div>
                ...
                <div class="row justify-content-between align-items-center mb-5 mb-lg-7">
                    <div class="col-lg-5">
                        ...
                        <p class="mb-5">Start your development with a open source dashboard with over 100 individual
                            components, giving you the freedom of choosing and combining. All components can take
                            variations in colour, that you can easily modify using SASS files.</p>
                        <div class="d-flex justify-content-between align-items-center mt-lg-4 mb-4">
                            <div class="d-block">
                                <a href="./dashboard/pages/dashboards/dashboard.html"
                                    class="btn btn-primary mr-3 animate-up-2 mb-3">Dashboard demo</a>
                                <a href="https://demos.creative-tim.com/impact-design-system-pro/docs/dashboard/alerts/"
                                    class="btn btn-outline-gray animate-up-2 mb-3"><i class="fas fa-th-large mr-2"></i>
                                    Components</a>
                            </div>
                        ...
                        <a href="https://creative-tim.com/" class="d-block mb-5" target="_blank">
                            <div class="author-image mr-2 d-flex">
                                <img src="./front/assets/img/creative-tim-logo.png" alt="Creative Tim Logo">
                                <div class="d-block text-black ml-3">
                                    <p class="mb-1 text-gray font-small">Created by</p>
                                    <h6>Creative Tim</h6>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <img src="./front/assets/img/presentation-mockup-3.jpg" alt="Dashboard Preview">
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-6 col-md-3 text-center mb-4">
                        <div
                            class="icon icon-shape icon-lg bg-white shadow-lg border-light rounded-circle icon-primary mb-4">
                            <i class="fas fa-pager"></i>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./front/pages/index.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/index-3.jpg"
                                alt="Landing page preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Landing<i
                    ...
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./front/pages/about.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/about.jpg"
                                alt="About page preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">About <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./front/pages/pricing.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/pricing.jpg"
                                alt="Pricing page preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Pricing <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./front/pages/contact.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/contact.jpg"
                                alt="Contact page preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Contact <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/dashboards/dashboard.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/dashboard.jpg"
                    ...
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/tables/tables.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/tables.jpg"
                                alt="Dashboard Tables preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Dashboard Tables <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/maps/google.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/map.jpg"
                                alt="Dashboard Maps preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Dashboard Maps <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/examples/profile.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/profile.jpg"
                                alt="Dashboard Profile preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Dashboard Profile <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/examples/register.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/register.jpg"
                                alt="Dashboard Register preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Dashboard Register <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                    <div class="col-6 col-lg-4 mb-5">
                        <a href="./dashboard/pages/examples/login.html" class="page-preview scale-up-hover-2">
                            <img class="shadow-lg rounded scale" src="./front/assets/img/pages/dashboard/login.jpg"
                                alt="Dashboard Login preview">
                            <div class="text-center show-on-hover">
                                <h6 class="m-0 text-center text-white">Dashboard Login <i
                                        class="fas fa-external-link-alt ml-2"></i></h6>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-6 mb-4">
                        <div class="d-none d-lg-block mt-5">
                            ...
                            <a href="https://demos.creative-tim.com/impact-design-system-pro/docs/getting-started/file-structure/"
                                class="btn btn-md btn-primary animate-up-2 mr-3"><i class="fas fa-book mr-1"></i> Docs
                                File Structure</a>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6 order-lg-first d-flex justify-content-center">
                        <ul class="d-block fmw-100 list-style-none folder-structure">
                            <li data-toggle="tooltip" data-placement="left"
                                title="Main folder that you will be working with"><i class="fas fa-folder mr-2"></i>src
                            </li>
                            <li>
                                <ul class="list-style-none pl-4">
                                    <li data-toggle="tooltip" data-placement="left" title="Front pages source files"><i
                                            class="fas fa-folder mr-2"></i> front</li>
                                    <li>
                                        <ul class="class list-style-none pl-4">
                                            <li data-toggle="tooltip" data-placement="left"
                                                title="CSS, Images, Fonts and Javascript"><i
                                                    class="fas fa-folder mr-2"></i> assets</li>
                                            <li data-toggle="tooltip" data-placement="left" title="HTML templates"><i
                                                    class="fas fa-folder mr-2"></i> pages</li>
                                            <li data-toggle="tooltip" data-placement="left"
                                                title="Partials are HTML snippets that are included in multiple pages, such as the menu or footer">
                                                <i class="fas fa-folder mr-2"></i> partials</li>
                                            <li data-toggle="tooltip" data-placement="left" title="Sass source files"><i
                                                    class="fas fa-folder mr-2"></i> scss</li>
                                        </ul>
                                    </li>
                                    <li data-toggle="tooltip" data-placement="left"
                                        title="Dashboard pages source files"><i class="fas fa-folder mr-2"></i>
                                        dashboard</li>
                                    <li>
                                        <ul class="class list-style-none pl-4">
                                            <li data-toggle="tooltip" data-placement="left"
                            ...
                            <li data-toggle="tooltip" data-placement="left"
                                title="Temporary folder that is created when serving files with BrowserSync"><i
                                    class="fas fa-folder text-muted mr-2"></i>.temp</li>
                            <li data-toggle="tooltip" data-placement="left" title="Minified version of the project">
                                <i class="fas fa-folder mr-2 text-muted"></i> dist
                            </li>
                            <li data-toggle="tooltip" data-placement="left"
                                title="Project dependencies from package.json"><i
                                    class="fas fa-folder text-muted mr-2"></i> node_modules
                            </li>
                            <li data-toggle="tooltip" data-placement="left"
                                title="Development workflow commands. We have them well documented."><i
                                    class="fab fa-js-square mr-2 text-warning"></i> gulpfile.js</li>
                            <li data-toggle="tooltip" data-placement="left"
                                title="The page you're looking at right now. Call it inception."><i
                                    class="fab fa-html5 mr-2 text-secondary"></i> index.html</li>
                            <li data-toggle="tooltip" data-placement="left" title="Project details and dependencies."><i
                                    class="fas fa-file-code mr-2 text-tertiary"></i> package.json</li>
                            <li data-toggle="tooltip" data-placement="left" title="No project can miss a README :)"><i
                                    class="fas fa-file-code mr-2 text-tertiary"></i> README.md</li>
                            <li data-toggle="tooltip" data-placement="left"
                                title="This file ensures that generated files and folder are ignored by Git. (eg. node_modules)">
                                <i class="fas fa-file-code mr-2 text-tertiary"></i> .gitignore
                            </li>
                        </ul>
                    </div>
        ...
        <section class="section section-lg bg-primary">
            <div class="container">
                <div class="row justify-content-center text-center text-white mb-5">
                    <div class="col-12">
                        <h2 class="h1 font-weight-light mb-3">Less <span class="font-weight-bold">work</span>, more
                            <span class="font-weight-bold">flow</span>.</h2>
                        <p class="lead px-lg-8">
                            Boost productivity with BrowserSync. Sass changes are reflected instantly and pages scroll
                ...
                <div class="row justify-content-center mb-6">
                    <div class="col-md-10 col-xl-9">
                        ...
                        <p class="mt-4 text-white text-center">Looks unfamiliar? Don’t worry! Our <a
                                class="text-white text-underline font-weight-bold"
                                href="https://demos.creative-tim.com/impact-design-system-pro/docs/getting-started/quick-start/">documentation</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        ...
                        <p class="lead mb-4">Impact design system is an open source project featuring premium
                            components, front pages and a dashboard. There's also a Pro version available with more
                            components, pages and plugins.</p>
                        <div class="d-flex align-items-center">
                            <a href="https://github.com/creativetimofficial/impact-design-system" target="_blank"
                        ...
                        <div class="card border-light p-4">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush price-list mb-4">
                                    ...
                                    <li class="list-group-item bg-white pl-0"><span class="icon-danger"><span
                                                class="fas fa-times-circle mr-2"></span></span> Premium plugins</li>
                                    <li class="list-group-item bg-white pl-0"><span class="icon-danger"><span
                                                class="fas fa-times-circle mr-2"></span></span> Charts</li>
                                    <li class="list-group-item bg-white border-0 pl-0 pb-0"><span
                                            class="icon-danger"><span class="fas fa-times-circle mr-2"></span></span>
                                        Premium Support</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card border-light p-4">
                            ...
                            <div class="card-body">
                                <ul class="list-group list-group-flush price-list mb-5">
                                    ...
                                    <li class="list-group-item bg-white pl-0"><span class="icon-success"><span
                                                class="fas fa-check-circle mr-2"></span></span> Premium plugins</li>
                                    <li class="list-group-item bg-white pl-0"><span class="icon-success"><span
                                                class="fas fa-check-circle mr-2"></span></span> Charts</li>
                                    <li class="list-group-item bg-white border-0 pl-0 pb-0"><span
                                            class="icon-success"><span class="fas fa-check-circle mr-2"></span></span>
                                        Premium Support</li>
                                </ul>
                                <a href="https://www.creative-tim.com/product/impact-design-system-pro" target="_blank"
                                    class="btn btn-block btn-primary animate-up-2"><span
                                        class="fas fa-paper-plane mr-2"></span> Upgrade to Pro</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 mb-4 mb-lg-0">
                        ...
                        <div class="dropdown mb-4 mb-lg-0">
                            <a id="langsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false" class="dropdown-toggle footer-language-link">
                                <img src="./front/assets/img/flags/united-states-of-america.svg" alt="USA Flag"
                                    class="language-flag"> English
                                <i class="fas fa-chevron-down ml-1"></i>
                            </a>
                            <div aria-labelledby="langsDropdown" class="dropdown-menu dropdown-menu-center">
                                <a href="#" class="dropdown-item text-gray text-sm"><img
                                        src="./front/assets/img/flags/germany.svg" alt="Germany Flag"
                                        class="language-flag"> German</a>
                                <a href="#" class="dropdown-item text-gray text-sm"><img
                                        src="./front/assets/img/flags/spain.svg" alt="Spain Flag" class="language-flag">
                                    Spanish</a>
                                <a href="#" class="dropdown-item text-gray text-sm"><img
                                        src="./front/assets/img/flags/france.svg" alt="France Flag"
                                        class="language-flag"> French</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-2 mb-4 mb-lg-0">
                        ...
                        <ul class="links-vertical">
                            ...
                            <li><a target="_blank" href="https://themesberg.com/contact?ref=creativetim">Contact Us</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-6 col-sm-3 col-lg-2 mb-4 mb-lg-0">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <h6>Subscribe</h6>
                        <p class="font-small">The latest Impact news, articles, and resources, sent straight to your
                            inbox every month.</p>
                        <form action="#">
                            <div class="form-row">
                                <div class="col-8">
                                ...
                                <div class="col-4">
                                    <button type="submit"
                                        class="btn btn-secondary btn-block"><span>Subscribe</span></button>
                                </div>
                            </div>
                        </form>
                        <small class="mt-2 form-text">We’ll never share your details. See our <a href="#"
                                class="font-weight-bold text-underline">Privacy Policy</a></small>
                    </div>
                </div>
