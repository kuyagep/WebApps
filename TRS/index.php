...
<body class="bg-white">
    <header class="header-global fixed-top bg-gradient-default">
        <div class="m-2 ml-5">
            <img src="./dashboard/assets/img/logo/deped-logo-white.png" width=500px" alt="">
                    ...
                    <div class="col-lg-5 col-md-7">
                            ...
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <form role="form">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary my-4" id="login-btn"> <i class="fas fa-sign-in-alt mr-2"></i>Sign
                                            in</button>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <a href="#" class="btn btn-md btn-secondary animate-up-2" id="forgot-link"></i> Forgot password?</a>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-8">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 text-right">
                                ...
                                <a href="#" class="btn btn-md btn-primary animate-up-2" id="login-link"> <i class="fas fa-sign-in-alt mr-2"></i></i></i>Login</a>
                            </div>
                        </div>
                    </div>
                </div>
